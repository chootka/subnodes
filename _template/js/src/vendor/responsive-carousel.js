		...
		methods = {
			...
			_addNextPrev: function(){
				var controls = "<div class=\"geui-hero-carousel-controls "+ navClass +"\">" +
                        	"<a href=\"#prev\" class=\"geui-hero-carousel-prev\"><i class=\"geui-icon geui-icon-white geui-icon-left-arrow\"></i></a>" +
                            "<a href=\"#next\" class=\"geui-hero-carousel-next\"><i class=\"geui-icon geui-icon-white geui-icon-right-arrow\"></i></a>" +
                        "</div>";

                // "<nav class='"+ navClass +"'><a href='#prev' class='prev' title='Previous'>Prev</a><a href='#next' class='next' title='Next'>Next</a></nav>"
				return $( this )
					.append( controls )
