...
}, '3.8.0pr2', {"use": ["get", "features", "intl-base", "yui-log", "yui-later"]});
...
YUI.add('yui', function (Y, NAME) {}, '3.8.0pr2', {"use": ["get", "features", "intl-base", "yui-log", "yui-later"]});
...
}, '3.8.0pr2', {"requires": ["oop", "features"]});
...
}, '3.8.0pr2', {"requires": ["dom-base", "dom-style"]});
...
}, '3.8.0pr2', {"requires": ["selector-native"]});
...
}, '3.8.0pr2', {"requires": ["dom-core", "selector"]});
...
}, '3.8.0pr2', {"requires": ["event-base", "node-core", "dom-base"]});
(function () {
...
}, '3.8.0pr2', {"requires": ["pluginhost-base"]});
...
}, '3.8.0pr2', {"requires": ["node-base", "event-delegate"]});
...
}, '3.8.0pr2', {"requires": ["node-base", "pluginhost"]});
...
}, '3.8.0pr2', {"requires": ["dom-style", "node-base"]});
...
}, '3.8.0pr2', {"requires": ["event-custom-base", "querystring-stringify-simple"]});
...
}, '3.8.0pr2', {"requires": ["selector-native", "selector-css2"]});
YUI.add('yui-log', function (Y, NAME) {
