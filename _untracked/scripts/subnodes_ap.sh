#! /bin/sh
### BEGIN INIT INFO
# Provides:          subnodes AP configuration
# Required-Start:    
# Required-Stop:     
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: Starts up ap0 interface and hostapd for broadcasting a wireless network.
# Description:       Starts up ap0 interface and hostapd for broadcasting a wireless network.
### END INIT INFO

# Author: Sarah Grant <info@subnod.es>
# Do NOT "set -e"

# PATH should only include /usr/* if it runs after the mountnfs.sh script
DESC="Brings up wireless access point for connecting to web server running on the device."
NAME=subnodes_ap
DAEMON=/home/pi/subnodes
DAEMON_ARGS="sudo NODE_ENV=production nodemon subnode.js"
...
[ -r /etc/default/subnodes ] && . /etc/default/subnodes
...
. /lib/init/subnodes_mesh_config.sh
